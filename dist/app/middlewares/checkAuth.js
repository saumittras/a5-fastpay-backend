...
const checkAuth = (...authRoles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (isUserExist.accountStatus === user_interface_1.status.BLOCKED ||
            isUserExist.accountStatus === user_interface_1.status.CLOSED) {
            throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, `User is ${isUserExist.accountStatus}`);
        }
        if (isUserExist.accountStatus === user_interface_1.status.DELETED) {
